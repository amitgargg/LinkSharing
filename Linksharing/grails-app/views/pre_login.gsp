...
<head>
    <meta name="layout" content="pre_login_defaultlayout" />
    <title></title>
</head>
        ...
        <div class="col-sm-5 col-sm-offset-1 blog-sidebar">
            <div class="sidebar-module sidebar-module-inset">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <g:form id="regForm" controller="registration" method="post" action="userRegistration" enctype="multipart/form-data" >
                            <fieldset>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <g:passwordField name="password" id="password" class="form-control" placeholder="Password" ></g:passwordField>
                                </div>
                                <div class="form-group">
                                    <g:passwordField name="confirmPassword" id="confirmPassword" class="form-control" placeholder="Confirm Password" ></g:passwordField>
                                </div>
                                <div class="form-group">
